...
// @RoleEquals(role) with role in admin|administrator, moderator|modo, fullUser|full_user|user, anon|anonymous without care of letter cases
class RoleEquals extends Annotation implements ValidableInterface {
	...
	public function isValid() {
		...
		if( $viewHelper->currentUserIs($this->role) ){
			return true;
		}else{
