...
use socialportal\model\TopicMindfulness;
...
class TopicMindfulnessForm extends AbstractTopicForm {
	
	public function __construct(FrontController $frontController) {
		parent::__construct( 'Mindfulness', $frontController, 'formMindfulnessSubmit', __( 'Submit' ) );
