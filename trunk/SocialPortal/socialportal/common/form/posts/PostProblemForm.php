...
use socialportal\model\PostProblem;
...
class PostProblemForm extends AbstractPostForm {
	public function __construct(FrontController $frontController) {
		parent::__construct( 'ProblemComment', $frontController, 'formProblemSubmit', __( 'Submit' ) );
