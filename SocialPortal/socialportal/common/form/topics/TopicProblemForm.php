...
use socialportal\model\TopicProblem;
...
class TopicProblemForm extends AbstractTopicForm {
	
	public function __construct(FrontController $frontController) {
		parent::__construct( 'Problem', $frontController, 'formProblemSubmit', __( 'Submit' ) );
